...
public class AllRecipeAdapter extends RecyclerView.Adapter<AllRecipeAdapter.ForecastAdapterViewHolder> {

    private static final String TAG = AllRecipeAdapter.class.getSimpleName();
    ...
    public AllRecipeAdapter(Context context, ForecastAdapterOnClickHandler clickHandler) {
